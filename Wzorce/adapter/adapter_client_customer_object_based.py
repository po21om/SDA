...
class Client:
    def __init__(self, full_name: str, contact_details: Union[Dict, None], number_of_transactions: int):
...
class ClientAdapter(Customer):
    ...
    def get_transaction_count(self) -> int:
        return self._client.get_numer_of_transactions()


if __name__ == "__main__":
    customers = [
        ClientAdapter(Client('John Kowalsky', {'email': 'johnkowalsky@example.com', 'phone': '123456789'}, 10)),
        ClientAdapter(Client('Joe Doe', {'email': 'joedoe@example.com', 'phone': '456123789'}, 12)),
        ClientAdapter(Client('Eve First', {'email': 'evefirst@example.com', 'phone': '789123456'}, 1000))
    ]
